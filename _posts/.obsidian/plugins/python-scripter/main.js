...
var Args = class {
  constructor(pass_vault_path, pass_current_file, additional_args, additional_args_desc, prompted, pythonExe = "", dotFile = "") {
    ...
    for (var index = 0; index < this.files.length; index++) {
      ...
      if (this.plugin.settings.args[file].pass_vault_path && this.plugin.settings.args[file].pass_current_file) {
        ...
        for (var i = 0; i < this.plugin.settings.args[file].length; i++) {
          ...
          new import_obsidian.Setting(containerEl).setName(`Description for Arg ${i + 3}`).addText((area) => {
            const index2 = i;
            area.setPlaceholder("Enter Description").setValue(this.plugin.settings.args[file].additional_args_desc[index2]).onChange((value) => {
              this.plugin.settings.args[file].additional_args_desc[index2] = value;
              this.plugin.saveSettings();
            });
          });
        ...
        for (var i = 0; i < this.plugin.settings.args[file].length; i++) {
          ...
          new import_obsidian.Setting(containerEl).setName(`Description for Arg ${i + 2}`).addText((area) => {
            const index2 = i;
            area.setPlaceholder("Enter Description").setValue(this.plugin.settings.args[file].additional_args_desc[index2]).onChange((value) => {
              this.plugin.settings.args[file].additional_args_desc[index2] = value;
              this.plugin.saveSettings();
        ...
        for (var i = 0; i < this.plugin.settings.args[file].length; i++) {
          ...
          new import_obsidian.Setting(containerEl).setName(`Description for Arg ${i + 1}`).addText((area) => {
            const index2 = i;
            area.setPlaceholder("Enter Description").setValue(this.plugin.settings.args[file].additional_args_desc[index2]).onChange((value) => {
              this.plugin.settings.args[file].additional_args_desc[index2] = value;
              this.plugin.saveSettings();
...
var ModalForm = class extends import_obsidian.Modal {
  constructor(app, additional_args, index, onSubmit) {
    super(app);
    this.additional_args = additional_args;
    this.index = index;
  ...
  onOpen() {
    ...
    new import_obsidian.Setting(contentEl).setName("Argument").setDesc(`${this.additional_args.additional_args_desc[this.index]}`).addText((text) => text.onChange((value) => {
      this.result = value;
    }));
